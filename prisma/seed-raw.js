...
async function main() {
  ...
  const questions = [
    ...
    { text: "Apakah ananda mengerjakan ibadah sunnah lainnya seperti, sholat sunnah and puasa sunnah?", type: "long_text", category: "Keluarga", order: 8 },
    ...
    { text: "Apakah Bapak/Ibu berkenan hadir saat acara sekolah yang melibatkan orang tua and mendukung program sekolah?", type: "choice", category: "Sekolah", options: ["Ya", "Tidak"], order: 29 },
  ...
  // Clear existing SMP questions
  await client.query("DELETE FROM \"FormQuestion\" WHERE level = 'SMP'")
  
  for (const q of questions) {
    const id = Math.random().toString(36).substring(7)
    await client.query(
      "INSERT INTO \"FormQuestion\" (id, text, type, category, \"order\", options, level) VALUES ($1, $2, $3, $4, $5, $6, $7)",
      [id, q.text, q.type, q.category, q.order, q.options || [], "SMP"]
    )
  }
